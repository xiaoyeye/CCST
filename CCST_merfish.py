...
def main(args):
    ...
    if args.cluster:
        ...
        #inv_X = pca.inverse_transform(X_embedding)  #将降维后的数据转换成原始数据
...
if __name__ == "__main__":
    ...
    parser.add_argument( '--lambda_I', default=0.5)
    ...
    lambdaI_list = [0.8, 1] 
    for args.lambda_I in lambdaI_list:
